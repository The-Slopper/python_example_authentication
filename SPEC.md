...
| Campo | Valor |
|---|---|
| Repositorio | `python_example_authentication` |
...
Modulo de autenticacao: verificacao de credenciais e emissao de sessao. Este documento descreve requisitos, arquitetura e criterios de aceite.
